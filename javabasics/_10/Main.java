...
public class Main {
    ...
    private static void exercise2() {
        ...
        boolean shoes = shoeType == "fancy";
        boolean ageForEntry = age > 18;
        boolean remainingEuros = eurosForEntry == 10;


        if (shoes && ageForEntry && remainingEuros) {
    ...
    private static void exercise3() {
        ...
        double ourGrade = ourTestScore / maxTestScore * 100;

        if (ourGrade >= 90) {
            System.out.println("A");
            isTestRetry = false;
        } else if (ourGrade >= 80 && ourGrade < 90) {
            System.out.println("B");
            isTestRetry = false;
        } else if (ourGrade >= 70 && ourGrade < 80) {
            System.out.println("C");
            isTestRetry = false;
        } else if (ourGrade >= 60 && ourGrade < 70) {
            System.out.println("D");
            isTestRetry = false;
        } else if (ourGrade >= 50 && ourGrade < 70) {
            System.out.println("F");
        } else if (isTestRetry){
            System.out.println("Ci dispiace, ma non hai raggiunto il punteggio necessario per superare il test. Riprova!");
        }
